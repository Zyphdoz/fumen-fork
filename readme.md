...
- fumen urls support starting with `#?` as in `http://harddrop.com/fumen/#?v115@vhAAgH`. This allows for sharing much longer fumen urls because these urls are character limited by the web browser instead of the server.

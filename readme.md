...
- fumen urls support starting with `#?` syntax as in `http://harddrop.com/fumen/#?v115@vhAAgH`. This allows for sharing much longer fumen urls because it is now character limited by the web browser instead of the server.
